...
AMs_Mt_data = pd.read_csv("/home/wuzefeng/MyResearch/ATAC_Seq_WET/Medicago_RNA/analysis_result/Mt_CK_AM.deg.csv",index_col=0)
AMs_Mt = list(AMs_Mt_data[AMs_Mt_data.change!="NOT"].index)

AMs_Gm_data = pd.read_csv("/home/wuzefeng/MyResearch/ATAC_Seq_WET/Gmax_RNA/analysis_result/DEG_AM_CK.csv",index_col=0)
AMs_Gm = list(AMs_Gm_data[AMs_Gm_data.change!="NOT"].index)

AMs_Lt_data = pd.read_csv("/home/wuzefeng/MyResearch/ATAC_Seq_WET/Lotus_RNA/analysis_result/Lt_CK_AM.deg.csv",index_col=0)
AMs_Lt = list(AMs_Lt_data[AMs_Lt_data.change!="NOT"].index)

AMs_Zm_data = pd.read_csv("/home/wuzefeng/MyResearch/ATAC_Seq_WET/Maize_RNA/analysis_result/DEG_AM_CK.csv",index_col=0)
AMs_Zm = list(AMs_Zm_data[AMs_Zm_data.change!="NOT"].index)

AMs_Ri_data = pd.read_csv("/home/wuzefeng/MyResearch/ATAC_Seq_WET/Rice_RNA/analysis_result/DEG_AM_CK.csv",index_col=0)
AMs_Ri = list(AMs_Ri_data[AMs_Ri_data.change!="NOT"].index)

AMs_Sy_data = pd.read_csv("/home/wuzefeng/MyResearch/ATAC_Seq_WET/Sly_RNA/analysis_result/DEG_AM_CK.csv",index_col=0)
AMs_Sy = list(AMs_Sy_data[AMs_Sy_data.change!="NOT"].index)

All_AMs = AMs_Mt + AMs_Gm + AMs_Lt + AMs_Zm + AMs_Ri+AMs_Sy

#outfile = open("/home/wuzefeng/MyResearch/ATAC_Seq_WET/2cross_species_compare/AM_orthogous","w")
outfile2 = open("/home/wuzefeng/MyResearch/ATAC_Seq_WET/2cross_species_compare/AM_orthogous_genes","w")
